...
const ListadoServiciosLatinTopJobs = () => {
  return (
    ...
    <section className="max-w-7xl mx-auto text-gray-600 body-font">
        <div className="lg:w-4/5 mx-auto flex flex-col px-5">
          ...
          <div className="flex flex-wrap sm:flex-row flex-col py-6 lg:mb-6">
            <h2 className="sm:w-3/5 text-gray-700 font-bold title-font text-xl lg:text-2xl sm:text-3xl">
              Qué ofrecemos
            </h2>
          </div>
        </div>
      <div className="lg:w-4/5 px-5 lg:pb-12 mx-auto">
        <div className="flex flex-wrap sm:mx-auto sm:mb-2 -mx-2">
          ...
          <div className="p-2 sm:w-1/2 w-full">
            <div className="bg-gray-100 rounded flex p-4 h-full items-center">
              ...
              <span className="title-font font-medium">Verificación de referencias.</span>
            </div>
          </div>
          <div className="p-2 sm:w-1/2 w-full">
            <div className="bg-gray-100 rounded flex p-4 h-full items-center">
              ...
              <span className="title-font font-medium">Aplicación de pruebas de honestidad.</span>
            </div>
          </div>
          <div className="p-2 sm:w-1/2 w-full">
            <div className="bg-gray-100 rounded flex p-4 h-full items-center">
              ...
              <span className="title-font font-medium">Verificación de referencias en la APC.</span>
            </div>
          </div>
          <div className="p-2 sm:w-1/2 w-full">
            <div className="bg-gray-100 rounded flex p-4 h-full items-center">
              ...
              <span className="title-font font-medium">Presentación de terna al cliente.</span>
            </div>
          </div>
          <div className="p-2 sm:w-1/2 w-full">
            <div className="bg-gray-100 rounded flex p-4 h-full items-center">
              ...
              <span className="title-font font-medium">Garantía de 3 meses sobre el candidato, ya sea porque se va voluntariamente o la empresa no desee continuar la relación durante los primeros 3 meses.</span>
            </div>
          </div>
        </div>
    ...
    <section className="max-w-7xl mx-auto text-gray-600 body-font">
      <div className="px-5 pb-6 lg:pb-12 mx-auto">
        ...
        <div className="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
          ...
          <div className="p-2 sm:w-1/2 w-full">
            <div className="bg-gray-100 rounded flex p-4 h-full items-center">
                ...
                <span 
                className="title-font font-medium ml-4">
