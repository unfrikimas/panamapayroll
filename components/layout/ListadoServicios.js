...
const ListadoServicios = () => {
  return (
        ...
        <div className="flex flex-wrap sm:mx-auto sm:mb-2 -mx-2">
          ...
          <div className="p-2 sm:w-1/2 w-full">
            <div className="bg-gray-100 rounded flex p-4 h-full items-center">
              ...
              <span className="title-font font-medium">Retiro de las fichas de la Caja de Seguro Social y su envío a los colaboradores.</span>
            </div>
          </div>
          <div className="p-2 sm:w-1/2 w-full">
            <div className="bg-gray-100 rounded flex p-4 h-full items-center">
              ...
              <span className="title-font font-medium">Emisión de cartas de trabajo y carta de ingresos anuales.</span>
            </div>
          </div>
        </div>
    ...
    <section className="max-w-7xl mx-auto text-gray-600 body-font">
      <div className="px-5 lg:pb-12 mx-auto">
    ...
    <section className="max-w-7xl mx-auto text-gray-600 body-font">
      <div className="px-5 pb-8 lg:pb-12 mx-auto">
        <div className="lg:w-4/5 flex flex-col mx-auto pt-16 lg:pt-8">
            <div className="h-1 bg-gray-200 rounded overflow-hidden">
                <div className="w-24 h-full bg-primario"></div>
            </div>
