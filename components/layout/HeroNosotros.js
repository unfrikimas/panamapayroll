...
const HeroNosotros = () => {
  return (
    <div class=" bg-white mx-auto">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:space-x-8 sm:flex-row sm:items-center">
        <div class="sm:w-1/2 w-full mb-10 lg:mb-0 rounded-lg overflow-hidden">
          <img
            alt="feature"
        ...
        <div class="sm:w-1/2">
          <p class="mt-4 text-sm leading-7 text-gray-500 font-regular tracking-wide">
            NOSOTROS
          </p>
          <h3 class="text-3xl sm:text-4xl leading-normal font-extrabold tracking-tight text-gray-900">
            Quiénes<span class="text-primario"> Somos</span>
          </h3>
